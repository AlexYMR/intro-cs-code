...
public class BinarySearchTree
{
	...
	if (isLeaf(n)){
	    BSTNode parentNode = findNode(n.parent.value);
	...
	if (n.right != null && n.left != null){
	    BSTNode successor = inorderSuccessor(n);
	    this.remove(successor.value);
	    n.value = successor.value;
	}
	else if (n.right != null){
	    BSTNode parentNode = findNode(n.parent.value);
	    if (parentNode.right != null && parentNode.right.equals(n)){
		parentNode.right = n.right;
	    }
	    else if (parentNode.left != null && parentNode.left.equals(n)){
