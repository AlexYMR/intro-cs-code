...
TEST_CASE("Initiating test..."){
	...
	SECTION("Testing the readGraph function"){
		cout << "\nTesting edge list readGraph function...\n";
		...
		string* eLabels = 0;
		int numEdges = 0;
		int v = readGraph(fin,edgeList,weights,numEdges,vLabels,eLabels);
